            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <form method="POST" id="kt_modal_update_permission_form" class="form">
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <label class="required form-label">Sub Menu</label>
                        <!--end::Select store template-->

                        <!--begin::Select2-->
                        <select name="sub_menu_id" data-dropdown-parent="#kt_modal_update_permission" data-control="select2" data-placeholder="Select a sub menu" class="form-select form-select-solid">
                            <option></option>
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <!--begin::Input-->
                        <select name="name" data-dropdown-parent="#kt_modal_update_permission" data-control="select2" data-placeholder="Select a option" class="form-select form-select-solid">
                            <option></option>
                    ...
                    <div class="text-center pt-15">
                        ...
                        <button type="submit" class="btn btn-primary" onclick="updatePermissionForm(this)">
...
<script>
    function updatePermissionForm(button) {
