    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-black-400 fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-200px">Updated Date</th>
                            ...
                            <tbody class="text-black-200">
                                ...
                                @foreach ($categories as $key => $category)
                                    <tr>
                                        ...
                                        <!--begin::Created Date=-->
                                        <td>{{ $category->created_at->setTimezone('Asia/Dhaka')->format('d M, Y / h:i A') }}</td>
                                        <!--end::Created Date=-->

                                        <!--begin::Updated Date=-->
                                        <td>{{ $category->updated_at->setTimezone('Asia/Dhaka')->format('d M, Y / h:i A') }}</td>
                                        <!--end::Updated Date=-->
                                        ...
                                        {{-- <td>
                                            <select
                                                ...
                                                onchange="user(this, {{ $user->id }})"
                                                class="form-select form-select-solid status" 
                                                data-control="select2" 
                                                data-hide-search="true">
                                                @foreach ($is_actives as $is_active)
                                                    <option value="{{ $is_active }}" {{ $user->is_active == $is_active ? 'selected' : '' }}>
                                                        {{ $is_active }}
                                                    </option>
                                                @endforeach
                                            </select>
                ...
                <!--begin::Modals-->
                <!--begin::Modal - Add Categories-->
                @include('Inventory::categories.modals.add')
